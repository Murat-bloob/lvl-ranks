...
app.get("/", (req, res) => {
  res.send('Hello There , This is Level System Bot and now its online Thanks (BunnySupport)')
});
...
client.on("ready", async () => {
  console.log(`Bunny is Now Online`);
  client.user
    .setActivity(
      ` +help | Bunny 2021 | Servers: : ${await client.guilds.cache
        .size} | Users : ${await client.users.cache.size}`,
      { type: "PLAYING" }
    )
