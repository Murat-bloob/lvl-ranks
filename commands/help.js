...
const prefix = config.prefix
    ...
    let help = new MessageEmbed()
      ...
      .addFields(
        { name: `Leveling Command`, value: `\`${prefix}rank\`, \`${prefix}leaderboard\`, \`${prefix}role-level\`, \`${prefix}add-level\,\`${prefix}remove-level\``},
      )
      .setTimestamp()
      .setFooter('Bunny Level System');
    ...
    if (!command) {
      return message.reply('That\'s not a valid command!');
        ...
        embed.setFooter('Bunny Level System');
